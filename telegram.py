...
async def result1(data, id):
    if status == 1:
        ...
        user_LY = 0
        try:
            ######Колбек дата для ответа а
            if (data["user_naber_71"] == 'a'):
                user_HO = user_HO + 1
            if (data["user_baber_2"] == 'a'):
                user_IN = user_IN + 1
            if (data["user_baber_3"] == 'a'):
                user_LY = user_LY + 1
            if (data["user_baber_4"] == 'a'):
                user_IN = user_IN + 1
            if (data["user_baber_5"] == 'a'):
                user_IN = user_IN + 1
            if (data["user_baber_6"] == 'a'):
                user_IN = user_IN + 1
                user_PR = user_PR + 1
                user_LY = user_LY + 1
            if (data["user_baber_7"] == 'a'):
                user_IN = user_IN + 1
                user_HO = user_HO + 1
                user_LY = user_LY + 1
            if (data["user_baber_9"] == 'a'):
                user_IN = user_IN + 1
                user_HO = user_HO + 1
                user_LY = user_LY + 1
            if (data["user_baber_10"] == 'a'):
                user_IN = user_IN + 1
                user_PR = user_PR + 1
                user_PA = user_PA + 1
                user_HO = user_HO + 1
            if (data["user_baber_11"] == 'a'):
                user_HO = user_HO + 1
                user_LY = user_LY + 1
            if (data["user_baber_12"] == 'a'):
                user_PA = user_PA + 1
            if (data["user_baber_13"] == 'a'):
                user_PA = user_PA + 1
                user_HO = user_HO + 1
            if (data["user_baber_16"] == 'a'):
                user_PR = user_PR + 1
                user_PA = user_PA + 1
            if (data["user_baber_17"] == 'a'):
                user_HO = user_HO + 1
            if (data["user_baber_18"] == 'a'):
                user_PR = user_PR + 1
            if (data["user_baber_20"] == 'a'):
                user_HO = user_HO + 1
            if (data["user_baber_21"] == 'a'):
                user_HO = user_HO + 1
            ######b
            if (data["user_baber_1"] == 'b'):
                user_PR = user_PR + 1
            if (data["user_baber_2"] == 'b'):
                user_HO = user_HO + 1
            if (data["user_baber_3"] == 'b'):
                user_PR = user_PR + 1
            if (data["user_baber_4"] == 'b'):
                user_PR = user_PR + 1
            if (data["user_baber_5"] == 'b'):
                user_PR = user_PR + 1
            if (data["user_baber_12"] == 'b'):
                user_IN = user_IN + 1
            if (data["user_baber_13"] == 'b'):
                user_PR = user_PR + 1
            if (data["user_baber_14"] == 'b'):
                user_PR = user_PR + 1
            if (data["user_baber_15"] == 'b'):
                user_HO = user_HO + 1
            if (data["user_baber_17"] == 'b'):
                user_PR = user_PR + 1
                user_PA = user_PA + 1
            if (data["user_baber_18"] == 'b'):
                user_HO = user_HO + 1
                user_LY = user_LY + 1
            if (data["user_baber_20"] == 'b'):
                user_PA = user_PA + 1
            ######c
            if (data["user_baber_1"] == 'c'):
                user_PA = user_PA + 1
            if (data["user_baber_2"] == 'c'):
                user_PR = user_PR + 1
            if (data["user_baber_3"] == 'c'):
                user_HO = user_HO + 1
            if (data["user_baber_4"] == 'c'):
                user_HO = user_HO + 1
            if (data["user_baber_5"] == 'c'):
                user_PA = user_PA + 1
            if (data["user_baber_6"] == 'c'):
                user_PA = user_PA + 1
                user_HO = user_HO + 1
            if (data["user_baber_7"] == 'c'):
                user_PR = user_PR + 1
                user_PA = user_PA + 1
            if (data["user_baber_8"] == 'c'):
                user_IN = user_IN + 1
                user_PR = user_PR + 1
                user_PA = user_PA + 1
                user_HO = user_HO + 1
                user_LY = user_LY + 1
            if (data["user_baber_9"] == 'c'):
                user_PR = user_PR + 1
                user_PA = user_PA + 1
            if (data["user_baber_10"] == 'c'):
                user_LY = user_LY + 1
            if (data["user_baber_11"] == 'c'):
                user_IN = user_IN + 1
                user_PR = user_PR + 1
                user_PA = user_PA + 1
            if (data["user_baber_12"] == 'c'):
                user_PR = user_PR + 1
                user_HO = user_HO + 1
            if (data["user_baber_14"] == 'c'):
                user_HO = user_HO + 1
            if (data["user_baber_16"] == 'c'):
                user_IN = user_IN + 1
            if (data["user_baber_17"] == 'c'):
                user_LY = user_LY + 1
            if (data["user_baber_20"] == 'c'):
                user_IN = user_IN + 1
            if (data["user_baber_22"] == 'c'):
                user_PR = user_PR + 1
                user_HO = user_HO + 1
            ######d
            if (data["user_baber_1"] == 'd'):
                user_IN = user_IN + 1
            if (data["user_baber_2"] == 'd'):
                user_PA = user_PA + 1
            if (data["user_baber_3"] == 'd'):
                user_HO = user_HO + 1
            if (data["user_baber_4"] == 'd'):
                user_PA = user_PA + 1
            if (data["user_baber_5"] == 'd'):
                user_LY = user_LY + 1
            if (data["user_baber_15"] == 'd'): #12
                user_LY = user_LY + 1
            if (data["user_baber_16"] == 'd'): #13
                user_LY = user_LY + 1
            if (data["user_baber_17"] == 'd'): #14
                user_IN = user_IN + 1
            if (data["user_baber_18"] == 'd'): #15
                user_PR = user_PR + 1
                user_PA = user_PA + 1
            if (data["user_baber_19"] == 'd'): #16
                user_LY = user_LY + 1
            if (data["user_baber_20"] == 'd'): #18
                user_IN = user_IN + 1
                user_PA = user_PA + 1
            if (data["user_baber_21"] == 'd'): #19
                user_PR = user_PR + 1
                user_HO = user_HO + 1
            if (data["user_baber_22"] == 'd'): #20
                user_LY = user_LY + 1
            if (data["user_baber_23"] == 'd'): #23
                user_IN = user_IN + 1
            ######e
            if (data["user_baber_1"] == 'e'):
                user_LY = user_LY + 1
            if (data["user_baber_2"] == 'e'):
                user_LY = user_LY + 1
            if (data["user_baber_3"] == 'e'):
                user_PA = user_PA + 1
            if (data["user_baber_4"] == 'e'):
                user_LY = user_LY + 1
            if (data["user_baber_5"] == 'e'):
                user_HO = user_HO + 1
            if (data["user_baber_16"] == 'e'): #13
                user_IN = user_IN + 1
            if (data["user_baber_17"] == 'e'): #14
                user_PA = user_PA + 1
                user_LY = user_LY + 1
            if (data["user_baber_18"] == 'e'): #15
                user_LY = user_LY + 1
            if (data["user_baber_19"] == 'e'): #19
                user_PA = user_PA + 1
                user_LY = user_LY + 1
            if (data["user_baber_20"] == 'e'): #21
                user_PR = user_PR + 1
            if (data["user_baber_21"] == 'e'): #23
                user_PR = user_PR + 1
            if (data["user_baber_23"] == 'e'):
                user_PR = user_PR + 1
            ######f
            if (data["user_baber_21"] == 'f'): #20
                user_PR = user_PR + 1
            if (data["user_baber_22"] == 'f'): #21
                user_LY = user_LY + 1
            if (data["user_baber_23"] == 'f'): #23
                user_IN = user_IN + 1
            ######g - net otveta
        except:
            pass
        # if not all(isinstance(val, (int, float)) for val in [user_IN, user_PR, user_PA, user_HO, user_LY]):
        #     largest_val = max([user_IN, user_PR, user_PA, user_HO, user_LY])
        #     return largest_val
        tipe = {'Инструментальный тип': user_IN, 'Профессиональный тип': user_PR, 'Патриотический тип ': user_PA, 'Хозяйский тип ': user_HO, 'Люмпенизированный': user_LY}
        max_keys = [key for key, value in tipe.items() if value == max(tipe.values())]
        # print(max_keys)

        text1 = f"Баллы которые вы набрали в за тест Герчикова: {user_IN} {user_PR} {user_PA} {user_HO} {user_LY}" \
            f"Результат теста по методу Герчикова: {max_keys}"
        # if max_keys
        await bot.send_message(id, text1)
        # await bot.send_message(id, user_full)
        await bot.send_message(id, 'Спасибо! Тестирование закончилось.')
        db.post_result(id, data['name'], data['email'], data['mob_tel'], max_keys, user_IN, user_PR, user_PA, user_HO)
    ...
    try:
        if len(message.text) == 11 and int(message.text):
            ...
            if status == '0':
                ...
                print('nachalo')
            if status == '1':
                await bot.send_message(message.from_user.id, btn1.ready)
                await bot.send_message(message.from_user.id, btn1.user_baber_1, reply_markup=btn1.choice3)
                j = Fsm.user_baber
                print('nachalo 1')
            await state.update_data(state=1)
            return
...
# мой кусочек с Герчиковым 
@dp.message_handler(commands=['test1'])
async def admin(message: types.Message, state: FSMContext):
    await bot.send_message(message.chat.id, btn1.text2, parse_mode='html')
    await bot.send_message(message.chat.id, btn.name)
    await Fsm.name.set()
    global status
    status = '1'
...
###### Для Герчинкова обработка сообщений
@dp.callback_query_handler(state=Fsm.user_baber)
async def user_baber(callback: types.CallbackQuery, state: FSMContext):
    await bot.answer_callback_query(callback_query_id=callback.id)
    await bot.delete_message(callback.from_user.id, callback.message.message_id)
    data = await state.get_data(state)
    state_user1 = data["state"]
    if callback.data == "⏭":
        state_user1 += 1
        print('da')
        if len(data) - state_user1 == 2:
                    # txt='Вы ответили не на все вопросы! Для коректного теста необходимо ответить на все'
                    # await bot.send_message(callback.from_user.id, txt)
            state_user1 -= 1
        ...
        dic = {f"user_baber_{state_user1}": callback.data}
        await state.update_data(dic)
        state_user1 += 1
        if state_user1 == 23:
            data = await state.get_data(state)
            await result1(data, callback.from_user.id)
            await state.finish()
            return
    await state.update_data(state=state_user1)
    txt = btn1.__dict__[f"user_baber_{state_user1}"]
    try:
        already_answer = data[f"user_baber_{state_user1}"]
        txt += f'''
<i>Ваш ответ:{already_answer}
</i>
'''
        ...
        pass
    if  1 <= state_user1 >= 5 or 16 <= state_user1 >= 20:
        await bot.send_message(callback.from_user.id, txt, reply_markup=btn1.choice1, parse_mode='html')
